...
<div class="searchable border border-gray-200 rounded-lg bg-white shadow-sm p-4">
  <h3 class="text-md font-semibold text-gray-900">Winning Mindset with Chris Koob</h3>
  <p class="text-sm text-gray-600">📅 Jul 14, 2025 | 🕒 10:00:00–11:00:00</p>
  <p class="text-sm text-gray-600">📍 Acadia Office</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="VISION">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> sales,six-figure,skills,training,Video,vision</p>
      <p><strong>Category:</strong> VISION</p>
      <p><strong>Summary:</strong> 321321321</p>
    </div>
  </details>
</div>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="PROSPECT">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> </p>
      <p><strong>Category:</strong> PROSPECT</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="EXERCISE">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> </p>
      <p><strong>Category:</strong> EXERCISE</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="OPENING">
  ...
  <details class="mt-2">
    <summary class="text-blue-600 text-sm cursor-pointer">Show more</summary>
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      <p><strong>Objectives:</strong> Showcase who we are as a company, what we do for middle income families and how we get paid. The goal of this is to identify potential clients who want a Financial Blueprint or interested in joining the team.</p>
      
      <p><strong>Tags:</strong> advanced,advanced investing,attendance,Awards & Recognition</p>
      <p><strong>Category:</strong> OPENING</p>
      <p><strong>Summary:</strong> This session breaks down what we do, who we serve, and how we get paid—in plain language. It’s designed to help you open conversations with confidence and clarity.</p>
    </div>
  </details>
</div>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="INVEST">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> basics,investments,recruiting,sales</p>
      <p><strong>Category:</strong> INVEST</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="CLOSE">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> </p>
      <p><strong>Category:</strong> CLOSE</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="FINLIT">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> </p>
      <p><strong>Category:</strong> FINLIT</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="ONBOARD">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> </p>
      <p><strong>Category:</strong> ONBOARD</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="INSPIRATIONAL">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> Video</p>
      <p><strong>Category:</strong> INSPIRATIONAL</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="INVEST">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> investments</p>
      <p><strong>Category:</strong> INVEST</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="MINDSET">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> </p>
      <p><strong>Category:</strong> MINDSET</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="LEADERSHIP">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> </p>
      <p><strong>Category:</strong> LEADERSHIP</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="Uncategorized">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Summary:</strong> Learn how to follow up with clients in a way that feels natural and helpful. This session shows how great service leads to more trust, more business, and more referrals.</p>
    </div>
  </details>
</div>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="COMP">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> </p>
      <p><strong>Category:</strong> COMP</p>
...
<div class="searchable module-card border border-gray-200 rounded-lg bg-white shadow-sm p-4" data-category="CLIENT_PRES">
  ...
  <details class="mt-2">
    ...
    <div class="text-sm text-gray-700 mt-2 space-y-1">
      ...
      <p><strong>Tags:</strong> </p>
      <p><strong>Category:</strong> CLIENT_PRES</p>
